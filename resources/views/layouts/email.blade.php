...
<head>
    ...
    * {
    ...
    @media (max-width: 480px) {
        ...
        #u_content_image_6 .v-text-align {
            text-align: center !important;
        }
    }
    </style>
            ...
            <tr style="vertical-align: top">
                <td style="word-break: break-word;border-collapse: collapse !important;vertical-align: top">
                    ...
                    <div class="u-row-container" style="padding: 0px;background-color: transparent">
                        <div class="u-row"
                            style="Margin: 0 auto;min-width: 320px;max-width: 600px;overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;background-color: #bedbf9;">
                            <div
                    ...
                    <div class="u-row-container" style="padding: 0px;background-color: transparent">
                        <div class="u-row"
                            style="Margin: 0 auto;min-width: 320px;max-width: 600px;overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;background-color: #182f3e;">
                            <div
                                style="border-collapse: collapse;display: table;width: 100%;background-color: transparent;">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            ...
                                                            <h1 class="v-text-align"
                                                                style="margin: 0px; color: #ffffff; line-height: 140%; text-align: center; word-wrap: break-word; font-weight: normal; font-family: trebuchet ms,geneva; font-size: 22px;">
                                                                ABOUT US
                                                            </h1>
                                                    ...
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            ...
                                                            <div class="v-text-align"
                                                                ...
                                                                <p style="font-size: 14px; line-height: 140%;">Want to
                                                                    change how you receive these emails?</p>
                                                                <p style="font-size: 14px; line-height: 140%;">You can
                                                                    update your preferences or<span
                                                                        style="text-decoration: underline; font-size: 14px; line-height: 19.6px;">
                                                                        unsubscribe</span> from this list.</p>
