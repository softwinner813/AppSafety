	                                ...
	                                <td class="v-container-padding-padding"
	                                    ...
	                                    <div class="v-text-align"
	                                        ...
	                                        <p style="font-size: 14px; line-height: 140%;"><span
	                                                ...
	                                                <strong>{{ $company_name }}</strong> provides you new account. You can login to our platform below information. <br/>We suggest that you should change the password after login.</span></p>
	                                    </div>
	                        ...
	                        <tbody>
	                            <tr>
	                                <td class="v-container-padding-padding"
	                                    ...
	                                    <div class="v-text-align "
	                                        style="color: #6b6b6b; line-height: 140%; text-align: center; word-wrap: break-word;">
	                                        <p style="font-size: 14px; line-height: 140%;text-align: center;"><span
	                                                style="font-family: Lato, sans-serif;">
	                                                <strong>Email : </strong>{{$email}}</span></p>
	                                        <p style="font-size: 14px; line-height: 140%; text-align: center;"><span
	                                                style="font-family: Lato, sans-serif;">
	                                                <strong>Password : </strong>{{$password}}</span></p>
	                                    </div>
	                            ...
	                            <tr>
	                                <td class="v-container-padding-padding"
	                                    ...
	                                    <div class="v-text-align" align="center">
	                                        ...
	                                        <a href="https://appsafely.co.uk/login" target="_blank"
	                                            ...
	                                            <span
	                                                style="display:block;padding:10px 50px;line-height:120%;"><span
	                                                    style="font-size: 14px; line-height: 16.8px;">Join</span></span>
	                                        </a>
