                    ...
                    <div class="d-flex flex-row-fluid flex-center">
                        ...
                        <div class="login-form">
                            ...
                            <form class="form" id="kt_login_singin_form" method="POST" action="{{ route('login') }}">
                                ...
                                <!--begin::Action-->
                                <div class="pb-lg-0 pb-5" style="display: flex; justify-content: space-between; align-items: center;">
                                    ...
                                    <a href="/register" class="text-primary font-size-h6 font-weight-bolder text-hover-primary">Register</a>
