        ...
        <div class="col-md-4">
            <div class="card" >
            	<div class="card" style="background-color: #3b3f48;padding-top: 30px;padding-bottom: 30px;">
            		<div id="email_icon">
            			<center >
            				<img width="25px;" height="25px;" src="http://localhost/icon_email.png">
            			</center> 
            		</div>
               	...
               	<div class="card" style=" padding: 20px 0 20px 0;color: white;padding-top: 20px;padding-bottom: 20px; background-color: #101010f0;font-family: arial;">
               		<div class="card-body">
	                   If you've lost your password or wish to reset it, user the code below to get started
	                </div>
	                <br>
	                <br>
	                <div class="card-body" style="font-weight: bold;font-size: 35px;">
	                   1234
	                </div>
	                 <br>
	                <br>
