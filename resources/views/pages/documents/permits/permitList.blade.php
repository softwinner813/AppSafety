                ...
                <div class="card card-custom">
                    <div class="card-header flex-wrap border-0 pt-6 pb-0">
                        ...
                        <div class="card-toolbar">
                            <!--begin::Button-->
                            <a href="{!! Route('document.permit.edit') !!}" class="btn btn-primary font-weight-bolder">
                        ...
                        <table class="datatable datatable-bordered datatable-head-custom datatable datatable-bordered datatable-head-custom datatable-default datatable-primary " id="kt_datatable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="col-md-2">
                                        <a href="{!! Route('document.permit.history', [$doc->id]) !!}" title="History" class="btn btn-light-primary btn-sm"><i class="fas fa-history"></i></a>
...
{{-- Scripts Section --}}
@section('scripts')
<script src="/js/pages/apps/documents/permit/permitTable.js"></script>
