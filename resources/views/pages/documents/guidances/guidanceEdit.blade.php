    ...
    <div class="container-fluid p-0" style='background-color: #eef0f8; font-family: "Helvetica Neue", "Helvetica", "Arial", "sans-serif"; height: 100% ; '>
		<!-- <div class="row"> -->
			<div class="row" style="height: 100%;">
				...
				<div class="col-md-10 col-xs-9 bg-green" style="position: relative; height: calc(100% + 20px); overflow-y: auto;">
            ...
            <form class="form" id="kt_add_email_form"  method="POST" action="{{ route('document.guidance.save') }}">
                ...
                <div class="modal-body">
                  ...
                  <div class="form-group">
                      <input class="form-control h-auto text-dark placeholder-dark bg-dark-o-20  border-0 py-4 px-8 mb-5 "  placeholder="Email" id="email" type="email" name="email"  required autocomplete="email" autofocus />
                  </div>
...
<script src="/js/pages/apps/documents/guidance/guidance.js"></script>
