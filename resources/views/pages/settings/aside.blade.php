            ...
            <div class="card-body pt-4">
                ...
                <div class="navi navi-bold navi-hover navi-active navi-link-rounded">
                    <div class="navi-item mb-2">
                        <a href="{{ route('profile') }}" class="navi-link py-4 active">
                    ...
                    <div class="navi-item mb-2">
                        <a href="{{ route('employee') }}" class="navi-link py-4">
                            <span class="navi-icon mr-2">
                                <span class="svg-icon">
                            ...
                            <span class="navi-text font-size-lg">Manage Employee</span>
                        </a>
                    </div>
                    <div class="navi-item mb-2">
                        <a href=" {{ route('change-password') }}" class="navi-link py-4">
                            <span class="navi-icon mr-2">
                                <span class="svg-icon">
                    ...
                    <div class="navi-item mb-2">
                        <a href="{{ route('membership') }}" class="navi-link py-4">
                            <span class="navi-icon mr-2">
                                <span class="svg-icon">
