            ...
            <div class="card-body pt-4">
                ...
                <div class="navi navi-bold navi-hover navi-active navi-link-rounded">
                    <div class="navi-item mb-2">
                        <a href=" {{ route('change-password') }}" class="navi-link py-4 {{ request()->is('setting/changepass') ? 'active' : '' }}">
                            <span class="navi-icon mr-2">
                                <span class="svg-icon">
                                    <!--begin::Svg Icon | path:/media/svg/icons/Communication/Shield-user.svg-->
                    ...
                    <div class="navi-item mb-2">
                        <a href="{{ route('profile') }}" class="navi-link py-4 {{ request()->is('setting/profile') ? 'active' : '' }}">
                            <span class="navi-icon mr-2">
                                <span class="svg-icon">
                    ...
                    <div class="navi-item mb-2">
                        <a href="{{ route('employee') }}" class="navi-link py-4 {{ request()->is('setting/employee') ? 'active' : '' }}">
                            <span class="navi-icon mr-2">
                                <span class="svg-icon">
                            ...
                            <span class="navi-text font-size-lg">Manage Users</span>
                        </a>
                    </div>

                    <div class="navi-item mb-2">
                        <a href="{{ route('membership') }}" class="navi-link py-4 {{ request()->is('setting/membership') ? 'active' : '' }}">
                            <span class="navi-icon mr-2">
                                <span class="svg-icon">
                                    <!--begin::Svg Icon | path:/media/svg/icons/Layout/Layout-top-panel-6.svg-->
                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                            <rect x="0" y="0" width="24" height="24" />
                            ...
                            <span class="navi-text font-size-lg">Membership</span>
                        </a>
                    </div>
                    @endif
